...
struct FSMData {
  ...
  vector<vector<int>> received_unassigned_grids_;
  vector<vector<int>> received_lately_order_;
  vector<int> swarm_unassigned_ids_;
};
...
struct ExplorationData {
  ros::Time start_time_, finish_time_, idle_time_;
  ...
  vector<int> uav_1_ids_, uav_2_ids_;
